"""
Report Generator Module for NOVA Claude Code Protector.
...
logger = logging.getLogger("nova-protector.report")

# NOVA Protector version
NOVA_VERSION = "0.1.0"
...
<head>
    ...
    <title>NOVA Session Report - {html.escape(session_id)}</title>
    <style>
        :root {{
    ...
    <div class="container">
        <div class="header">
            <div class="header-top">
                <div class="logo">NOVA <span>Protector</span></div>
        ...
        <div class="metadata-section">
            ...
            <div class="metadata-grid">
                ...
                <div class="metadata-item">
                    <span class="metadata-label">NOVA Version</span>
        ...
        <div class="footer">
            Generated by NOVA Claude Code Protector v{NOVA_VERSION}<br>
